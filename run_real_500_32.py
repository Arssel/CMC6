...
best_weights, weights, name, loss, reward = train(model, device="cuda", problem_size=500, num_vehicles=50,
                            batch_size=32, epochs=50, T=1000, lr=1e-4, decay=0.001, save_inbetween=True,
